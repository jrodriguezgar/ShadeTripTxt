...
_DETERMINANTS = ['QUESTO', 'QUESTA', 'QUESTI', 'QUESTE', 'QUELLO', 'QUELLA', 'MIO', 'MIA', 'MIEI', 'MIE', 'TUO', 'TUA', 'TUOI', 'TUE', 'SUO', 'SUA', 'SUOI', 'SUE']

# Articoli
_ARTICLES = ['IL', 'LO', 'LA', 'I', 'GLI', 'LE', 'UN', 'UNO', 'UNA', "L'", "UN'"]

# Preposizioni (semplici + articolate)
_PREPOSITIONS = ['A', 'AL', 'ALLO', 'ALLA', 'AI', 'AGLI', 'ALLE', 'CON', 'DA', 'DAL', 'DALLO', 'DALLA', 'DAI', 'DAGLI', 'DALLE', 'DI', 'DEL', 'DELLO', 'DELLA', 'DEI', 'DEGLI', 'DELLE', 'FRA', 'TRA', 'IN', 'NEL', 'NELLO', 'NELLA', 'NEI', 'NEGLI', 'NELLE', 'PER', 'SU', 'SUL', 'SULLO', 'SULLA', 'SUI', 'SUGLI', 'SULLE', 'SECONDO', 'SENZA', 'SOPRA', 'SOTTO', 'VERSO']
