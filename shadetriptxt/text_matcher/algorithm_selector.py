...
class AlgorithmSelector:
    ...
    OPTIMAL_ALGORITHMS = {
        ...
        UseCase.EMAIL: {"primary": "levenshtein", "secondary": [], "reason": "Exact match needed, no phonetics", "speed_gain": 1.0},
        UseCase.PHONE: {"primary": "hamming", "secondary": ["levenshtein"], "reason": "Fixed format, digit accuracy critical", "speed_gain": 8.0},
        UseCase.PRODUCT_CODE: {"primary": "hamming", "secondary": ["levenshtein"], "reason": "Fixed format codes (ABC-123-XYZ)", "speed_gain": 9.0},
        ...
        UseCase.LICENSE_PLATE: {"primary": "hamming", "secondary": ["levenshtein"], "reason": "Short, fixed format", "speed_gain": 10.0},
        UseCase.SHORT_TEXT: {
            "primary": "jaro_winkler",
            "secondary": ["levenshtein"],
        ...
        UseCase.GENERAL: {"primary": "levenshtein", "secondary": ["jaro_winkler"], "reason": "Balanced general-purpose algorithm", "speed_gain": 1.0},
    }

    def __init__(self, use_case: Optional[UseCase] = None, auto_detect: bool = True):
        """
    ...
    def get_optimal_config(self, text1: str, text2: str, use_case_override: Optional[UseCase] = None) -> Dict[str, Any]:
        """
    ...
    def _get_optimal_thresholds(self, use_case: UseCase, text1: str, text2: str) -> Dict[str, Any]:
        """
        ...
        threshold_map = {
            UseCase.PERSON_NAME: {"levenshtein": 0.85, "jaro_winkler": 90.0, "metaphone_required": True},
            UseCase.COMPANY_NAME: {"levenshtein": 0.80, "jaro_winkler": 85.0, "metaphone_required": False},
            UseCase.ADDRESS: {"levenshtein": 0.75, "token_overlap": 0.80, "metaphone_required": False},
            UseCase.CITY: {"levenshtein": 0.85, "jaro_winkler": 90.0, "metaphone_required": True},
            UseCase.POSTAL_CODE: {"hamming": 0.90, "levenshtein": 0.95, "metaphone_required": False},
            UseCase.EMAIL: {"levenshtein": 0.95, "metaphone_required": False},
            UseCase.PHONE: {"hamming": 0.85, "levenshtein": 0.90, "metaphone_required": False},
            UseCase.PRODUCT_CODE: {"hamming": 0.90, "levenshtein": 0.95, "metaphone_required": False},
            UseCase.INVOICE_NUMBER: {"levenshtein": 0.90, "hamming": 0.85, "metaphone_required": False},
            UseCase.LICENSE_PLATE: {"hamming": 0.85, "levenshtein": 0.90, "metaphone_required": False},
            UseCase.SHORT_TEXT: {"jaro_winkler": 90.0, "levenshtein": 0.85, "metaphone_required": False},
            UseCase.LONG_TEXT: {"token_overlap": 0.75, "levenshtein": 0.70, "metaphone_required": False},
            UseCase.GENERAL: {"levenshtein": 0.85, "jaro_winkler": 90.0, "metaphone_required": True},
        }

        return threshold_map.get(use_case, threshold_map[UseCase.GENERAL])

    def explain_selection(self, text1: str, text2: str, use_case_override: Optional[UseCase] = None) -> str:
        """
