...
def _import_similarity():
    ...
    from ..utils.string_similarity import WordSimilarity, are_words_equivalent, calculate_similarity
...
class MatcherConfig:
    ...
    def strict(cls) -> "MatcherConfig":
        ...
        """
        return cls(levenshtein_threshold=0.95, jaro_winkler_threshold=0.95, metaphone_required=True)
    ...
    def lenient(cls) -> "MatcherConfig":
        ...
        Example:
            ...
            matcher = TextMatcher(config=config)
        """
        return cls(levenshtein_threshold=0.75, jaro_winkler_threshold=0.80, metaphone_required=False)
    ...
    def fuzzy(cls) -> "MatcherConfig":
        ...
        Example:
            ...
            matcher = TextMatcher(config=config)
        """
        return cls(levenshtein_threshold=0.65, jaro_winkler_threshold=0.70, metaphone_required=False)
...
class TextMatcher:
    ...
    def __init__(self, config: Optional[MatcherConfig] = None, locale: Optional[str] = None, enable_cache: bool = True, cache_size: int = 1024):
        """
    ...
    def run_custom(
        ...
        if name not in self._custom_functions:
            raise ValueError(f"Custom function '{name}' not registered. Registered: {list(self._custom_functions.keys())}")
    ...
    def list_custom(self) -> Dict[str, str]:
        ...
        """
        return {name: getattr(fn, "__qualname__", repr(fn)) for name, fn in self._custom_functions.items()}

    # ------------------------------------------------------------------
    # Text normalization
    # ------------------------------------------------------------------

    def normalize_text(self, text: str, for_names: bool = False, case_mode: str = "upper", config: Optional[MatcherConfig] = None) -> str:
        """
    ...
    def _align_lists(self, list1: List[str], list2: List[str], fuzzy_match: bool = False) -> Tuple[List[Optional[str]], List[Optional[str]]]:
        """
        ...
        def are_words_similar(w1, w2):
            ...
            is_match, _ = self._are_words_equivalent(w1, w2, levenshtein_threshold=0.80, jaro_winkler_threshold=0.85, metaphone_required=False)
    ...
    def compare_phrases(self, phrase1: str, phrase2: str, threshold: float = 0.8) -> Tuple[bool, Dict[str, Any]]:
        ...
        if not phrase1 or not phrase2:
            return False, {"distance": 1.0, "similarity": 0.0, "score": 0.0, "common_words": [], "unique_to_phrase1": [], "unique_to_phrase2": []}
    ...
    def find_phonetic_duplicates(self, names: List[str], threshold: float = 0.8, use_mra: bool = True) -> List[List[str]]:
        """
    ...
    def find_common_patterns(self, text1: str, text2: str, min_length: int = 3) -> Dict[str, Any]:
        """
        ...
        if not text1 or not text2:
            return {"lcs_length": 0, "lcs_ratio": 0.0, "similarity": 0.0, "score": 0.0, "has_significant_overlap": False}
    ...
    def compare_text_detailed(
        self, text1: str, text2: str, case_sensitive: bool = False, show_diff: bool = True, context_lines: int = 3
    ) -> Dict[str, Any]:
        """
        ...
        result = {
            "ratio": ratio,
            "score": score,
            "matching_blocks": [{"text1_start": block.a, "text2_start": block.b, "length": block.size} for block in matching_blocks],
            "opcodes": [
                {
                    "operation": op,
                    "text1_start": i1,
        ...
        if show_diff:
            ...
            diff_generator = difflib.unified_diff(original_lines1, original_lines2, fromfile="text1", tofile="text2", lineterm="", n=context_lines)
    ...
    def compare_code_blocks(
        self, code1: str, code2: str, language: str = "python", ignore_whitespace: bool = True, ignore_comments: bool = False
    ) -> Dict[str, Any]:
        """
        ...
        original_result = self.compare_text_detailed(code1, code2, case_sensitive=True, show_diff=False)
        ...
        result = {
            **normalized_result,
            ...
            "preprocessing": {"language": language, "ignore_whitespace": ignore_whitespace, "ignore_comments": ignore_comments},
        }

        return result

    def compare_name_bytokens(
        self, name1: str, name2: str, threshold: float = 0.9, keep_order: bool = True, normalize_names: bool = True, fuzzy_align: bool = False
    ) -> Tuple[bool, Dict[str, Any]]:
        """
        ...
        for word1, word2 in zip(list_name1, list_name2):
            ...
            if w1 and w2:
                ...
                is_word_match, word_metrics = self.compare_names(w1, w2, strict=False)

                word_pair_matches.append(1 if is_word_match else 0)
                metrics["word_pair_comparisons"].append({"word1": w1, "word2": w2, "match": is_word_match, "metrics": word_metrics})
            else:
                word_pair_matches.append(0)
                metrics["word_pair_comparisons"].append({"word1": w1, "word2": w2, "match": False, "metrics": {"note": "One or both words empty"}})
        ...
        # Rule #2: Word count difference - number of differences equals number of non-similar words
            ...
            len(split_name1) > 2
            and len(split_name2) > 2
            and min_coincidences > 2
            and abs(len(split_name1) - len(split_name2)) == max(len(split_name1), len(split_name2)) - min_coincidences
        ):
            result = True
    ...
    def compare_names(self, name1: str, name2: str, strict: bool = False, config: Optional[MatcherConfig] = None) -> Tuple[bool, Dict[str, Any]]:
        """
        ...
        # Validación tautológica
        if name1 == name2:
            return True, {"exact_match": True, "levenshtein_ratio": 1.0, "jaro_winkler_score": 100.0, "metaphone_match": True}
    ...
    def compare_text(self, text1: str, text2: str) -> Dict[str, Any]:
        ...
        if text1 == text2:
            return {"sorensen_dice": 1.0, "ratcliff_obershelp": 1.0, "exact_match": True}
    ...
    def find_best_match(self, target: str, candidates: List[str], threshold: float = 0.85) -> Tuple[Optional[str], float, Dict[str, Any]]:
        """
        ...
        **Note:** For getting multiple matches, use compare_lists() instead.
        ...
        for candidate in candidates:
            if target == candidate:
                return candidate, 1.0, {"exact_match": True, "levenshtein_ratio": 1.0, "jaro_winkler_score": 100.0, "metaphone_match": True}
    ...
    def detect_duplicates(
        ...
        **Performance Optimizations**:
        ...
        results = self.batch_compare(pairs_to_compare, config=cfg, parallel=parallel, max_workers=max_workers, levenshtein_threshold=threshold)
        ...
        for candidate in candidates:
            if target == candidate:
                exact_matches.append(
                    (candidate, 1.0, {"exact_match": True, "levenshtein_ratio": 1.0, "jaro_winkler_score": 100.0, "metaphone_match": True})
                )
        ...
        **kwargs,
        ...
        if not parallel or len(pairs) < 100:  # Use parallel only for larger batches
            ...
            for pair in pairs:
                ...
                # Validación tautológica
                if word1 == word2:
                    results.append((True, {"exact_match": True, "levenshtein_ratio": 1.0, "jaro_winkler_score": 100.0, "metaphone_match": True}))
                    continue
    ...
    def _get_cached_comparison(self, word1: str, word2: str, **kwargs) -> Optional[Tuple[bool, Dict[str, Any]]]:
        """
    ...
    def _cache_comparison(self, word1: str, word2: str, result: Tuple[bool, Dict[str, Any]], **kwargs):
        """
    ...
    def get_cache_stats(self) -> Dict[str, Any]:
        ...
        """
        if not self._enable_cache:
            return {"enabled": False, "size": 0, "hits": 0, "misses": 0, "hit_rate": 0.0}
    ...
    def _compare_pair_worker(self, pair: Tuple[str, str], compare_params: Dict[str, Any]) -> Tuple[bool, Dict[str, Any]]:
        """
    ...
    def _add_debug_info(
        self, metrics: Dict[str, Any], word1: str, word2: str, is_match: bool, config: Optional[MatcherConfig] = None
    ) -> Dict[str, Any]:
        """
        ...
        if cfg.metaphone_required:
            if metaphone_match:
                debug_info["reasons"].append("✓ Metaphone Pass (Phonetically similar)")
            else:
                debug_info["reasons"].append("✗ Metaphone Fail (Different phonetic sounds)")
        else:
            debug_info["reasons"].append("○ Metaphone Not Required")

        # Levenshtein analysis
        if lev_ratio >= cfg.levenshtein_threshold:
            debug_info["reasons"].append(f"✓ Levenshtein Pass ({lev_ratio:.4f} >= {cfg.levenshtein_threshold})")
        else:
            debug_info["reasons"].append(f"✗ Levenshtein Fail ({lev_ratio:.4f} < {cfg.levenshtein_threshold})")
        ...
        if jaro_score_normalized >= cfg.jaro_winkler_threshold:
            debug_info["reasons"].append(f"✓ Jaro-Winkler Pass ({jaro_score_normalized:.4f} >= {cfg.jaro_winkler_threshold})")
        else:
            debug_info["reasons"].append(f"✗ Jaro-Winkler Fail ({jaro_score_normalized:.4f} < {cfg.jaro_winkler_threshold})")
...
To be or not to be, that remains the question."""
            ...
            result = self.compare_text_detailed(text1, text2, case_sensitive=False, show_diff=True, context_lines=2)
...
def calculate_mean(numbers):
    return calculate_sum(numbers) / len(numbers)"""
            ...
            result1 = self.compare_code_blocks(code1, code2, language="python", ignore_comments=False, ignore_whitespace=True)

            # Compare ignoring comments
            result2 = self.compare_code_blocks(code1, code2, language="python", ignore_comments=True, ignore_whitespace=True)
    ...
    return fetch(url)
        ...
        .then(data => {
            ...
            result = self.compare_code_blocks(code1, code2, language="javascript", ignore_comments=True, ignore_whitespace=True)
    ...
    print(i)"""
            ...
            result = self.compare_code_blocks(snippet1, snippet2, language="python", ignore_whitespace=True)

            assert result["structural_similarity"] > 90, (
                f"Expected high similarity for formatting differences, got {result['structural_similarity']}%"
            )
    ...
    def validate_email(self):
        ...
        return re.match(pattern, self.email) is not None"""
            ...
            result = self.compare_text_detailed(version_old, version_new, case_sensitive=True, show_diff=True, context_lines=3)
        ...
        def test_simple_similarity_check():
            ...
            for text1, text2, expected_min_score in test_cases:
                result = self.compare_text_detailed(text1, text2, case_sensitive=False, show_diff=False)

                assert result["score"] >= expected_min_score, (
                    f"Expected score >= {expected_min_score}%, got {result['score']}% for '{text1}' vs '{text2}'"
                )
...
if __name__ == "__main__":
    ...
    test_pairs = [("Smith", "Smyth"), ("casa", "perro"), ("python", "pithon")]
    ...
    pairs = [("aplicacion", "aplikacion"), ("telefono", "telefno")]
    ...
    products = ["iPhone 15 Pro Max", "Samsung Galaxy S24 Ultra", "Google Pixel 8 Pro", "OnePlus 12 Pro", "Xiaomi 14 Ultra"]
    ...
    text_result = matcher.compare_text_detailed("The quick brown fox", "The fast brown fox", show_diff=False)
    print(f"   Similarity: {text_result['score']:.1f}%")
    print(f"   Lines changed: {text_result['lines_changed']}")

    print("\n6.3 Quick code comparison demo:")
    code_result = matcher.compare_code_blocks("def hello(): print('hi')", "def hello(): print('hello')", language="python")
